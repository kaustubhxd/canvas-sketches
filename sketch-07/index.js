...
},{"./utils/autoAdjustCanvas":4,"canvas-sketch":1,"tweakpane":2}],4:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.autoAdjustCanvas = void 0;
...
const resizeObserver = new ResizeObserver(entries => {
  ...
  for (let entry of entries) {
    if (entry.contentRect) {
      ...
      if (!isCanvasPanelClashingXAxis) return; // check which axis the canvas should translate to. if X-axis, exit resizeObserver
      ...
      if (panelMarginLeft - canvasWidth > 0) {
        ...
        window.requestAnimationFrame(() => {
          canvasNode.style.marginLeft = canvasMarginLeft - (canvasMarginLeft + canvasWidth - panelMarginLeft + 20) + "px"; // canvasNode.style.width = originalSize.cSide + "px";
          // canvasNode.style.height = originalSize.cSide + "px";

          canvasNode.addEventListener("transitionend", () => {
            console.log("Transition ended");
            canvasNode.style.transition = "none"; // canvasNode.removeEventListener("transitionend", handleMouseDown, true);
          });
        });
        return;
      }
      ...
      if (panelTotalHeightFromTop > canvasMarginTop) {
        ...
        const updatedCanvasMarginTop = canvasMarginTop + canvasPanelOverlapHeight + canvasPanelMarginTop + "px";
      ...
      console.log("paneldown", {
        panelTotalHeightFromTop,
        canvasMarginTop
      });
      console.log(canvasNode, canvasNode.style); // const updatedCanvasMarginTop = canvasHeight + panelHeight + "px";
...
const autoAdjustCanvas = (canvas, panelNode, isPanelOpen) => {
...
exports.autoAdjustCanvas = autoAdjustCanvas;
